...
items[1] = document.getElementById('rightTurns');
items[2] = document.getElementById('motorway');
items[3] = document.getElementById('mainRoads');
items[4] = document.getElementById('residential');
