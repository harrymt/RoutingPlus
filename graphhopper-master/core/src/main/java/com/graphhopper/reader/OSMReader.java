...
public class OSMReader
{
    ...
    void processWay( OSMWay way )
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            {
                // append highway flags to way flags and pass into applyNodeFlags
                String highwayFlags = way.getTag("highway");
                wayFlags = encodingManager.applyNodeFlags(wayFlags, -nodeFlags, highwayFlags);
            }
        }
