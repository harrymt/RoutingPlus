...
public class GraphHopper implements GraphHopperAPI
{
    ...
    public GHResponse route( GHRequest request )
    {
        ...
        } else
        {
            ...
            // BEGIN G52GRP GROUP
            // pass the prferences from the GHRequest into the weight calculator (Weighting)
            weighting.setPrefs(request.getMotorwayPreference(), request.getMainRoadPreference(), request.getTrafficSignalPreference(),
             request.getResidentialPreference(), request.getRightTurnPreference());
            //END G52GRP GROUP
