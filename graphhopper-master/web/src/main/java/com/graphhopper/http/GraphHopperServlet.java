...
public class GraphHopperServlet extends GHBaseServlet {
    ...
    void writePath(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ...
            int motorway = (int) getDoubleParam(req, "motorway", 1);
            int mainRoads = (int) getDoubleParam(req, "mainRoads",1);
            int trafficSignals = (int) getDoubleParam(req,"trafficSignals",1);
            int residential = (int) getDoubleParam(req,"residential",1);
            int rightTurns = (int) getDoubleParam(req,"rightTurns",1);
            ...
            if (hopper.getEncodingManager().supports(vehicleStr)) {
                ...
                rsp = hopper.route(new GHRequest(start, end).
                        ...
                        setPrefs(motorway, mainRoads, trafficSignals, residential, rightTurns).
